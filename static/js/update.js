...
// HEALTH STATUS
function showDiv1(patient_status, option)
{
    document.getElementById(patient_status).style.display = option.value == "infected" ? 'block' : 'none';
}


// SYMPTOMATIC ASYMPTOMATIC
function showDiv2(patient_asymptomatic, option)
{
